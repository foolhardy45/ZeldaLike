        ...
        while (change.next()) {
            for(Munition munition : change.getAddedSubList()) {
                switch(munition.getDirection()){
                    case 1:  munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionGaucheBas.png")));
                        break;
                    case 2: munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionBas.png")));
                    break;
                    case 3:  munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionDroiteBas.png")));
                        break;
                    case 4: munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionGauche.png")));
                    break;
                    case 5:  //munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionBas.png")));
                        break;
                    case 6: munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionDroite.png")));
                    break;
                    case 7:  munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionGaucheHaut.png")));
                        break;
                    case 8:
                        ...
                        break;
                    case 9:  munitionVue = new MunitionVue(munition,String.valueOf(Main.class.getResource("images/gressif_gun/munitionDroiteHaut.png")));
                        break;
                }
